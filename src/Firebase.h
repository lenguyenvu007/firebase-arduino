...
class Firebase {
 ...
 // Update json encoded `value` at `path`.
    FirebaseUpdate update(const std::string& path, const std::string& json);
    virtual std::unique_ptr<FirebaseUpdate> updatePtr(const std::string& path, const std::string& json);
